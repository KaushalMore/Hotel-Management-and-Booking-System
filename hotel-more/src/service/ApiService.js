...
export default class ApiService {
    ...
    static async freezeRoom(roomId, userId, booking) {
        const response = await axios.post(`${this.BASE_URL}/bookings/freeze-booking/${roomId}/${userId}`, booking, {
            headers: this.getHeader()
        })
    ...
    static async getBookingByConfirmationCode(bookingCode) {
        const result = await axios.get(`${this.BASE_URL}/bookings/get-by-confirmationCode/${bookingCode}`)
        return result.data
    }
    ...
    static async fetchPaymentDetails(paymentId, PayerID) {
        try {
            const response = await axios.get(`${this.BASE_URL}/payment/success`, {
