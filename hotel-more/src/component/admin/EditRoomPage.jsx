        ...
        <div className="edit-room-container">
            ...
            <div className="edit-room-form">
                <div className="form-group">
                    {preview ? (
                        <img src={extractImageName(preview)} alt="Room Preview" className="room-photo-preview" />
                    ) : (
                        roomDetails.roomPhotoUrl && (
                            <img src={extractImageName(roomDetails.roomPhotoUrl)} alt="Room" className="room-photo" />
                        )
                    )}
                    <input
                        type="file"
